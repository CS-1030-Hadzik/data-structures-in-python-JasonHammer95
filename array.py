...
#problem 2. In the array.py create an array named 'cars' with the following elements in this order ---- Ford,Chrysler, Dodge,Ram,Jeep,Chevy,GMC` (use single quotes for each element) 
...
#problem 17. ceate a variable called arry_string with a value of 'The length of my array is ' (spelling, capitilization, and space matter)
...
print('================')
element = 1
for car in cars: # goes for len of list (i=0, i<cars.len, i++)
    print(element, car)
